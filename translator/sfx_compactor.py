import translator.note
import translator.sfx
...
class SfxCompactor:
    ...
    def get_track_section(self, track, sfxIndexStart, n):
        ...
        trackSection.sfxList = track[i:i + n]
    ...
    def optimize_sfx_speeds(self, n):
        longestTrackLength = self.get_longest_track_length()

        i = 0
        while i < len(longestTrackLength):
            trackSections = get_track_sections(i, n)
            ...
            if allRunsDivideEvenly:
                ...
                for trackSection in trackSections:
                    ...
                    # Delete the now-empty SFXes
                    del self.tracks[i + 1 : i + n]
                    i += 1
            else:
                i += n
